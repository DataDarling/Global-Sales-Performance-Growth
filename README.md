# Project Title: Global Sales Performance & Revenue Growth Analysis
...
Geographic Drill-down: Implemented a filled map with interactive filtering, allowing stakeholders to drill from national performance down to state-level metrics.

Product Mix Optimization: Utilized a Tree Map to visualize the hierarchy of 17+ sub-categories, highlighting that while "Technology" has the highest revenue, "Office Supplies" has the highest order volume.

Operational Efficiency: Developed a donut chart to analyze shipping mode distribution, identifying that "Standard Class" accounts for nearly 60% of all orders.
...
Regional Powerhouses: California and New York were identified as the primary revenue drivers, while several Midwestern states showed high Average Order Values despite lower total volume, representing an untapped market opportunity.

Shipping Strategy: The 4-day average shipping delay is consistent across regions, providing a baseline for future "Express Shipping" marketing campaigns.
